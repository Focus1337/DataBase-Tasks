...
(
	...
	CONSTRAINT pk_dp_dish FOREIGN KEY(dish_id)
			REFERENCES Dishes(id)
			on delete cascade on update cascade,

	CONSTRAINT pk_dp_product FOREIGN KEY(product_id)
...
(
	...
	CONSTRAINT pk_recipe_dish FOREIGN KEY(dish_id)
			REFERENCES Dishes(id)
			on delete cascade on update cascade,
)
...
(
	...
	CONSTRAINT pk_cooking_dish FOREIGN KEY(dish_id)
			REFERENCES Dishes(id)
			on delete cascade on update cascade
)